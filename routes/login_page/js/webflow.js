...
Webflow.require('ix').init([
  {"slug":"dropdown","name":"dropdown","value":{"style":{"display":"none","opacity":0,"width":"0px"},"triggers":[]}},
  {"slug":"new-interaction","name":"New Interaction","value":{"style":{},"triggers":[{"type":"hover","selector":".dropdown-item","stepsA":[{"display":"block","opacity":1,"width":"100px","transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms, width 500ms ease 0ms","x":"-90px","y":"0px"}],"stepsB":[{"opacity":0,"width":"0px","transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms, width 500ms ease 0ms","x":"0px","y":"0px"},{"display":"none"}]}]}}
]);
