...
/* Short registration for new main page. USE THIS for not processing */
router.post('/short-registration', function(req, res, next) {
    ...
    if(req.body.name && req.body.email)
    {
        ...
        if(!isEmail) return res.redirect('https://www.apracing.io/#email-form');
        ...
        // first name for email
        let firstName = name.split(' ')[0];

        // attempting to add new user to database
